...
HD_PWD='D:/klsa/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_system_wrapper.tcl
